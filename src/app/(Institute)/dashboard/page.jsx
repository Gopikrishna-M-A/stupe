          ...
          <table className='min-w-full divide-y divide-gray-200'>
            <thead className='bg-gray-50'>
              <tr>
                <th
                  scope='col'
                  className='pl-2 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider'>
                  Name
                </th>
                <th
                  scope='col'
                  className='md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider'>
                  Amount
                </th>
                <th
                  scope='col'
                  className='hidden md:table-cell md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider'>
                  Date
                </th>
                <th
                  scope='col'
            ...
            <tbody className='bg-white divide-y divide-gray-200'>
              {transactions?.slice(0, 5).map((transaction) => (
                <tr key={transaction?._id}>
                  <td className='pl-2 md:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900'>
